  ...
  return (
    <section className="space-y-8">
      <div className="space-y-3">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">Вхід</h1>
      </div>

      <div className="space-y-6 rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-12">
        <p className="text-lg text-slate-700">Авторизація буде додана на наступному етапі.</p>
        <Link
          href="/"
