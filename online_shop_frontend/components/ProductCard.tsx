    ...
    <article className="flex flex-col overflow-hidden rounded-2xl border bg-white shadow-sm">
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <button
          ...
          className="mt-auto cursor-pointer rounded bg-blue-600 px-4 py-2 font-medium text-white transition hover:bg-blue-700 active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-slate-300"
        >
